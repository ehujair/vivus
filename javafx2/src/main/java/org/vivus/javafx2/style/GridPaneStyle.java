...
public class GridPaneStyle extends Application {
	...
	public void start(final Stage stage) {
		...
		// layout the scene in a stackpane with some padding so that the grid is
		// centered
		...
		// can be uncommented to show the grid lines for debugging purposes, but
		// not particularly useful for styling purposes.
