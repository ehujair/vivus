package org.vivus.javafx2.scrollbar;
...
public class ScrollBarSample extends Application {
	...
	private void init(Stage primaryStage) {
		...
		Rectangle bg = new Rectangle(xBarWidth + yBarWidth, xBarHeight + yBarHeight, Color.rgb(90,
				90, 90));
	...
	private ScrollBar horizontalScrollBar(double minw, double minh, double prefw, double prefh,
	...
	// Create a ScrollBar with given parameters
	private ScrollBar verticalScrollBar(double minw, double minh, double prefw, double prefh,
			double maxw, double maxh) {
		final ScrollBar scrollBar = new ScrollBar();
		scrollBar.setMinSize(minw, minh);
		scrollBar.setPrefSize(prefw, prefh);
