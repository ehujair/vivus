package org.vivus.javafx.circle;
...
public class ColorCirclesPrint extends Application {
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.show();
		PrintUtil.print(root, primaryStage, "ColorCirclesPrint");
	}

	public void print(Group root) {
