...
public class JXSearchFieldAddon extends AbstractComponentAddon {
	...
	protected void addBasicDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		defaults.add("SearchField.popupRolloverIcon",
	...
	protected void addWindowsDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		if (UIManager.getLookAndFeel().getClass().getName().indexOf("Classic") == -1) {
			buttonMargin = new InsetsUIResource(0, -1, 0, -1);
		} else {
			buttonMargin = new InsetsUIResource(0, 0, 0, 0);
		}
		defaults.add("SearchField.buttonMargin", buttonMargin);
	...
	protected boolean isWindows(LookAndFeelAddons addon) {
		return super.isWindows(addon)
				|| (UIManager.getLookAndFeel().getClass().getName().indexOf("Windows") != -1 || UIManager
						.getLookAndFeel().getClass().getName().indexOf("PlasticXP") != -1);
	}
